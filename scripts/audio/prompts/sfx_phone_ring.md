...
<!-- NOTE:BEGIN -->
retro-futuristic phone ring, soft synthetic trill, warm electronic tone, one ring
<!-- NOTE:END -->
...
```bash
python scripts/audio/prompt_builder.py build --bom-id sfx_phone_ring
python scripts/audio/elevenlabs_client.py gen  --bom-id sfx_phone_ring
python scripts/audio/audio_pipeline.py intake --bom-id sfx_phone_ring
```
