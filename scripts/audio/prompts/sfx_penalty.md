...
<!-- NOTE:BEGIN -->
one low soft comical thud, rounded woody bump, ominous but cute
<!-- NOTE:END -->
...
<!-- PROMPT:BEGIN -->
```
one low soft comical thud, rounded woody bump, ominous but cute. Duration about 0.8 seconds. Style: cozy cute toy-like game sound, soft wooden marimba and rounded synth plucks, playful little pitch bends, gentle and warm, light and bouncy. Single isolated sound effect, dry and close, no background music, no vocals, no long reverb tail.
```
<!-- PROMPT:END -->
