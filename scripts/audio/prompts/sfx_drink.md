...
<!-- NOTE:BEGIN -->
8-bit can opening, short noise-channel fizz then one small bubbly square-wave gulp
<!-- NOTE:END -->
...
<!-- PROMPT:BEGIN -->
```
8-bit can opening, short noise-channel fizz then one small bubbly square-wave gulp. Duration about 1.2 seconds. Style: 8-bit retro game sound design, chiptune sound chip, square wave and noise channel, subtle and understated, dark comedy tone, readable in a busy mix. Single isolated sound effect, dry and close, no background music, no vocals, no long reverb tail.
```
<!-- PROMPT:END -->
