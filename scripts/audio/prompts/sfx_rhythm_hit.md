...
<!-- NOTE:BEGIN -->
8-bit hit note, one short square-wave tap with quick upward pitch flick, bright
<!-- NOTE:END -->
...
<!-- PROMPT:BEGIN -->
```
8-bit hit note, one short square-wave tap with quick upward pitch flick, bright. Duration about 0.5 seconds. Style: 8-bit retro game sound design, chiptune sound chip, square wave and noise channel, subtle and understated, dark comedy tone, readable in a busy mix. Single isolated sound effect, dry and close, no background music, no vocals, no long reverb tail.
```
<!-- PROMPT:END -->
