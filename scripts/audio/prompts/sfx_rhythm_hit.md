...
<!-- NOTE:BEGIN -->
one bright bouncy toy pluck with a little upward bend, happy
<!-- NOTE:END -->
...
<!-- PROMPT:BEGIN -->
```
one bright bouncy toy pluck with a little upward bend, happy. Duration about 0.5 seconds. Style: cozy cute toy-like game sound, soft wooden marimba and rounded synth plucks, playful little pitch bends, gentle and warm, light and bouncy. Single isolated sound effect, dry and close, no background music, no vocals, no long reverb tail.
```
<!-- PROMPT:END -->
