...
<!-- NOTE:BEGIN -->
two calm urgent synth pings, rounded electronic tone, tense but soft
<!-- NOTE:END -->
...
<!-- PROMPT:BEGIN -->
```
two calm urgent synth pings, rounded electronic tone, tense but soft. It plays when the game event DeadlineWarned fires. Duration about 0.8 seconds. Style: retro-futuristic cyberpunk bar game sound, soft rounded FM synth tones, warm analog character, smooth attack, subtle and cozy, clean in a busy mix. Single isolated sound effect, dry and close, no background music, no vocals, no long reverb tail.
```
<!-- PROMPT:END -->
