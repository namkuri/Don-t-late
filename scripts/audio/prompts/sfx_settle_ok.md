...
<!-- NOTE:BEGIN -->
cheerful rising toy xylophone run, four quick bright notes hopping up, ending with a sparkly ding, triumphant and cute
<!-- NOTE:END -->
...
<!-- PROMPT:BEGIN -->
```
cheerful rising toy xylophone run, four quick bright notes hopping up, ending with a sparkly ding, triumphant and cute. Duration about 1.5 seconds. Style: cozy cute toy-like game sound, soft wooden marimba and rounded synth plucks, playful little pitch bends, gentle and warm, light and bouncy. Single isolated sound effect, dry and close, no background music, no vocals, no long reverb tail.
```
<!-- PROMPT:END -->
