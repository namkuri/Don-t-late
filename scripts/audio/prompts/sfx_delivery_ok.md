...
<!-- NOTE:BEGIN -->
A bright two-tone doorbell ding-dong followed by a small coin chime.
<!-- NOTE:END -->
...
python scripts/audio/audio_pipeline.py normalize --bom-id sfx_delivery_ok
python scripts/audio/audio_pipeline.py promote   --bom-id sfx_delivery_ok --yes   # ⚠ 별도 승인
```
