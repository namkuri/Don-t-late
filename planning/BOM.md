...
> eta_min 실측 대체 — calibration.md 109건 기계 집계 기준 **발주 리드 중앙값 14.5분·p90 78분**(완료 94건 — 07-29 파서 변형 헤더 수용으로 27건 복원). 개별 미실측 eta는 이 분포를 표준시간으로 사용(AAPP A5). 반입 = 사람 수동 → `_intake/<도구명>/` (D-009).
