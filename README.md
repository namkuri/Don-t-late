<p align="center">
  <img src="./Assets/Art/Textures/intro.png" alt="늦지마 인트로 배너" width="100%" />
</p>
...
| 특징 | 설명 |
| --- | --- |
| **시간 압박과 경로 선택** | 배송마다 제한 시간이 존재합니다. 빠른 길이 항상 안전한 길은 아니며, 어떤 주문을 먼저 처리할지에 따라 전체 결과가 달라집니다. |
| **한국 동네 기반의 공간** | 복도식 아파트, 빌라촌, 먹자골목, 언덕길처럼 익숙한 한국 주거 공간을 배경으로 구성했습니다. |
| **픽셀 아트와 3D 공간의 결합** | 픽셀 감성의 캐릭터와 UI를 3D 공간에 배치해, 평면적인 친근함과 입체적인 이동감을 함께 표현합니다. |
| **주민 중심의 옴니버스 이야기** | 하나의 거대한 서사보다, 배송 중 만나는 사람들의 짧고 선명한 에피소드가 쌓여 동네 전체의 이야기가 됩니다. |
