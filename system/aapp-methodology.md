...
> **실전 진화 각주 (2026-07-29·S-093)**: 코드/씬 레인에서는 발주 봉투(orders/*.md)가 라우팅 시트의
> 실전 축약형으로 정착했다(계획-실행 통합의 본질 유지). 시트 원형의 첫 정식 발행 실증 =
> planning/routing/RT-20260729-01.md (scene_data · scan-record-verify · done).
