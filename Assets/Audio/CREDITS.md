...
| bom_id | 요청 길이 | seed | 프롬프트 SHA1 |
|---|---|---|---|
| `sfx_settle_ok` | 1.5s | 329695474 | `14e70052bbb6` |
| `sfx_settle_bad` | 1.5s | 991850239 | `e32cb7e87205` |
| `sfx_furniture_place` | 0.6s | 828376204 | `3ae477c11215` |
| `sfx_ui_tick` | 0.5s→0.3s 트림 | 2017916970 | `e7cffaea06ac` |

- 후공정 적용 완료(6세대 표준): 앞 무음 트림 → 피크 -1dB → RMS -14dB. 정산 쌍(ok/bad)은 같은 마림바 계열 상행/하행 대비(규칙 §2 쌍 규칙).
